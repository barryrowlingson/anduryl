...
from anduryl.ui.models import ItemDelegate, ItemsBoundsModel, ItemsListsModel
...
class ItemsWidget(QtWidgets.QFrame):
    ...
    def construct_widget(self):
        ...
        self.table.horizontalHeader().setSectionHidden(2, True)
    ...
    def contextMenuEvent(self, event):
        ...
        menu = menus.ItemsContextMenu(self, event)
